...
int main() {
	...
	cout << "you wake up to find yourself in a dark and scary street it has asian architecture you look everywhere theres nowhere to go but foward " << endl;
	...
	do { // beginning of game loop
		...
		switch (room) {
		case 1:
			cout << "You get up to look around, you get this wiff of the smell of moldy walls" << endl << "you look everywhere" << endl;
			cout << "you see a cabin down north" << endl << "something tells you that you have to go towards the cabin." << endl;
			cin >> input;
			if (input == "north")
				room = 2;
			else
		...
		case 2:
			monster();
			cout << "you are now in the cabin" << endl << "you see something reflecting from one of the walls" << endl;
		...
		case 4:
			...
			cout << "hmm i wonder what the key goes to" << endl << "the exit is to the east" << endl;
			cin >> input;
			if (input == "east")
				room = 3;
			else
		...
		case 5:
			...
			cout << "You feel a strong urge to grab the coins its like they are calling your name" << endl << "you hear running from around the corner North. You can go back towards the old door West" << endl;
			cin >> input;
			if (input == "north")
				room = 6;
			else if (input == "west")
		...
		case 6:
			...
			cout << "you see a small opening on the wall going to a pitch dark room north that you could squeeze trough" << endl << "to the east you see a big skinny creature staring at you, occasionally looking down at the coins you are holding. you can also go back south" << endl;
			cin >> input;
			if (input == "north")
				room = 8;
			else if (input == "east")
			...
			break;
		case 7:
			cout << "the creature wispers in a unhuman voice, i can trade you items for those coins..." << endl;
		...
		case 8:
			if (items[1] == "flashlight") {
				items[4] = "key4";
				cout << "you got a key to the big old door you saw" << endl;
		...
		case 9:
			...
			break;
		case 10:
			cout << "as you walk into the room you get a sense of releif as you see a stairway leading into a door going up" << endl << "finally an exit its finally over..." << endl;
...
void pet() {
	int num = rand() % 100;
	if (num < 20)
		cout << "bear wags its tail" << endl;
	else if (num < 50)
		cout << "bear barks" << endl;
	else
		cout << "bear scratches himself" << endl;
}
